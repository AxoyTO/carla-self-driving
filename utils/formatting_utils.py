...
def format_vehicle_model_name(type_id_str: str) -> str:
    ...
    # Example: vehicle.tesla.model3 -> Tesla Model3
...
def format_compass_direction(raw_yaw_deg: float) -> str:
    ...
    standard_compass_deg = (90 - raw_yaw_deg + 360) % 360 # Convert CARLA yaw to standard compass
    cardinal_directions = ["N", "NE", "E", "SE", "S", "SW", "W", "NW", "N"] # Extra N for rounding edge case
