...
class PygameVisualizer:
    ...
    def get_current_view_display_name(self) -> str:
        ...
        return self.view_display_names.get(raw_key, raw_key)
    ...
    def _render_notifications(self, screen_surface):
        ...
        start_y = self.display_surface.get_height() - 10
    ...
    def _create_lidar_surface(self, lidar_points_local: np.ndarray, 
        ...
        lidar_relative_transform = carla.Transform(carla.Location(x=0.0, z=2.5))
        ...
        ego_color = (0, 255, 0); vw_m, vl_m = 1.8, 4.5
        ...
        angle_pygame = -vehicle_yaw_rad_map_frame
    ...
    def render(self, raw_sensor_data_item: any, current_view_key: str, debug_info_from_env: dict, lidar_sensor_range_from_env: float = 0.0):
        ...
        self._render_notifications(self.display_surface)
